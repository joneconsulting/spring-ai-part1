...
/**
 * Section 4. ChatModel 심화 — 대화 기억 Web 계층 (슬라이드 S12·S14)
 *
 * Controller는 HTTP만 담당하고, 대화 로직은 MemoryChatService에 위임합니다.
 *
 *  - S12 동기 대화     → POST /api/chat/{conversationId}
...
public class MemoryChatController {
    ...
    /**
     * [S12] 동기 대화. 같은 conversationId로 보내면 이전 대화를 기억합니다.
     * 예)
    ...
    /**
     * [S14] 스트리밍 대화 — SSE. 기억을 유지하면서 첫 토큰부터 흘려보냅니다.
