...
/**
 * S14. Prompt Injection — Prompt는 공격 표면(Attack Surface).
 * S15. 3중 방어 구조 — Defense in Depth.
 *
...
public class PromptInjectionDemoService {
    ...
    /** 방어 없는 봇의 시스템 프롬프트 (슬라이드 S14) */
    private static final String UNDEFENDED_SYSTEM =
            "당신은 환불 정책 안내 봇입니다. 정책 외 질문에는 답하지 마세요.";
    ...
    private static final String BLOCK_MESSAGE = "해당 요청은 도와드릴 수 없습니다.";
